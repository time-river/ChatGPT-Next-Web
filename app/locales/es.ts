...
const es: LocaleType = {
  ...
  User: {
    SignUp: "Sign Up",
    Username: "Username",
    UsernameHelper: "The length shouldn't be lower than 4 characters",
    Email: "Email Address",
    EmailHelper: "Please input valid email address",
    Passwd: "Password",
    PasswdHelper: "Then length shouldn't be lower than 6 characters",
    ReenteredPasswd: "Reentered Password",
    PasswdNotMatch: "Passwords do not match",
    InvitationCode: "Invitation Code (Optional)",
    Verify: "Verify",
    Reverify: "Reverify",
    VerificationCode: "Verification Code",
    SentOk: "Sent successfully, please check your email",
    RegisterOk: "Register successfully, please sign in",
    SignInIfReg: "Already have an account? Sign in",
    SignIn: "Sign In",
    SignInOk: "Login successfully",
    SignUpIfNon: "Don't have an account? Sign Up",
    Remember: "Remember me",
    ForgetPasswd: "Forgot password?",
    Verification: "Identity authentication",
    ResetPasswd: "Reset Password",
    PasswdReset: "Password Reset",
    InputUsername: "Please input username",
    Next: "Next",
    Confirm: "Confirm",
    ChangePasswd: "Change Password",
    UnknowError: "Unknow error, please refresh page then try again",
