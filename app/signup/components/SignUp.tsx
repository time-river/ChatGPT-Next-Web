...
export default function SignUp() {
  ...
  const [sendText, setSendText] = React.useState(Locale.User.Verify);
  ...
  React.useEffect(() => {
    ...
    if (seconds > 0) {
      ...
      setCanSend(true);
      setSendText(Locale.User.Reverify);
    }
  ...
  const usernameOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (pattern.test(data)) {
      ...
      setUsernameText("");
      setUsernameHelperText(Locale.User.UsernameHelper);
    }
  };
  ...
  const emailOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (pattern.test(data)) {
      ...
      setEmailText("");
      setEmailHelperText(Locale.User.EmailHelper);
    }
  };
  ...
  const passwdOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (pattern.test(data)) {
      ...
      if (data !== reenteredPasswdText) {
        ...
        setReenteredPasswdHelperText(Locale.User.PasswdNotMatch);
      } else {
  ...
  const codeOnError = () => {
    setTipType("error");
    setTipText(Locale.User.UnknowError);
    setTipStatus(true);
  };
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  fullWidth
                  name="invitationCode"
                  label={Locale.User.InvitationCode}
                  id="invitationCode"
                />
              </Grid>
              <Grid item xs={9}>
                <TextField
                  ...
                  fullWidth
                  id="code"
                  label={Locale.User.VerificationCode}
                  name="code"
                />
              </Grid>
              <Grid item xs={3}>
